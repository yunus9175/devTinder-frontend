...
export function AuthLayout({
  ...
  return (
    <div className="flex-1 min-h-0 flex flex-col items-center justify-center bg-gradient-to-br from-base-200 via-base-100 to-base-200 safe-area-padding px-4 sm:px-6 py-6 sm:py-8">
      {/* Form panel - centered in viewport without needing scroll */}
